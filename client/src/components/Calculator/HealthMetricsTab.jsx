...
export default function HealthMetricsTab() {
  ...
  return (
    <div className="space-y-8">
      {/* Introduction Card */}
      <div className="bg-gradient-to-r from-emerald-700 via-teal-700 to-slate-800 dark:from-emerald-900 dark:via-teal-900 dark:to-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-md relative overflow-hidden transition-colors">
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-emerald-100 dark:text-emerald-200/90 text-xs sm:text-sm leading-relaxed">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {/* BMR Card */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col justify-between transition-colors">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Chỉ số BMR</span>
          ...
          <div>
            <div className="text-3xl font-black text-slate-800 dark:text-white">
              {activeStats.bmr} <span className="text-sm font-semibold text-slate-400 dark:text-slate-500">kcal</span>
            </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col justify-between transition-colors">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Chỉ số TDEE</span>
          ...
          <div>
            <div className="text-3xl font-black text-amber-700 dark:text-amber-400">
              {activeStats.tdee} <span className="text-sm font-semibold text-slate-400 dark:text-slate-500">kcal</span>
            </div>
            <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col justify-between transition-colors">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Chỉ số BMI</span>
          ...
          <div>
            <div className="flex items-baseline space-x-2">
              <span className="text-3xl font-black text-slate-800 dark:text-white">{activeStats.bmi}</span>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col justify-between transition-colors">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Nước khuyến nghị</span>
          ...
          <div>
            <div className="text-3xl font-black text-sky-700 dark:text-sky-400">
              {activeStats.water} <span className="text-sm font-semibold text-slate-400 dark:text-slate-500">Lít/ngày</span>
            </div>
            <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 border border-slate-200/80 dark:border-slate-800 shadow-sm transition-colors">
        <div className="flex items-center justify-between pb-4 mb-6 border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-800 dark:text-white m-0">Công Cụ Thử Nghiệm & Tùy Chỉnh Chỉ Số</h3>
          ...
          <button
            ...
            className="text-xs text-slate-500 dark:text-slate-400 hover:text-emerald-700 dark:hover:text-emerald-400 flex items-center space-x-1 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-7 space-y-5 text-left">
            ...
            <div>
              <div className="flex justify-between text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">
                ...
                <span className="text-emerald-700 dark:text-emerald-400">{simForm.height} cm</span>
              </div>
              <input
                type="range"
                min="130"
            ...
            <div>
              <div className="flex justify-between text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">
                ...
                <span className="text-emerald-700 dark:text-emerald-400">{simForm.weight} kg</span>
              </div>
              <input
                type="range"
                min="35"
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl text-slate-800 dark:text-slate-100 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500"
              >
          ...
          <div className="md:col-span-5 bg-gradient-to-b from-slate-50 to-emerald-50/40 dark:from-slate-800/80 dark:to-emerald-950/30 rounded-3xl p-6 border border-emerald-200/80 dark:border-emerald-800/60 flex flex-col justify-between transition-colors">
            <div>
              <div className="text-xs font-bold text-emerald-800 dark:text-emerald-300 uppercase tracking-wider mb-4">
                ...
                return (
                  <div className="space-y-4">
                    <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm">
                      <span className="text-[11px] text-slate-400 dark:text-slate-500 font-bold uppercase">Mục tiêu Calo mới</span>
                      <div className="text-3xl font-black text-emerald-700 dark:text-emerald-400">
                        {s.targetCalories} <span className="text-sm font-semibold text-slate-500 dark:text-slate-400">kcal/ngày</span>
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center text-xs">
                      <div className="bg-white dark:bg-slate-800 p-2.5 rounded-xl border border-slate-100 dark:border-slate-700">
                        <span className="text-[10px] text-indigo-600 dark:text-indigo-400 font-bold">Đạm</span>
                        <div className="font-extrabold text-slate-800 dark:text-white">{s.macros.protein}g</div>
                      </div>
                      <div className="bg-white dark:bg-slate-800 p-2.5 rounded-xl border border-slate-100 dark:border-slate-700">
                        <span className="text-[10px] text-amber-600 dark:text-amber-400 font-bold">Carb</span>
                        <div className="font-extrabold text-slate-800 dark:text-white">{s.macros.carbs}g</div>
                      </div>
                      <div className="bg-white dark:bg-slate-800 p-2.5 rounded-xl border border-slate-100 dark:border-slate-700">
                        <span className="text-[10px] text-rose-600 dark:text-rose-400 font-bold">Béo</span>
                        <div className="font-extrabold text-slate-800 dark:text-white">{s.macros.fat}g</div>
                      </div>
                    </div>
                    ...
                    <div className="text-xs text-slate-500 dark:text-slate-400 space-y-1 pt-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold text-slate-700 dark:text-slate-200">{s.bmr} kcal</span>
                      </div>
                      <div className="flex justify-between">
                        <span>TDEE tiêu thụ:</span>
                        <span className="font-bold text-slate-700 dark:text-slate-200">{s.tdee} kcal</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Chỉ số BMI:</span>
                        <span className="font-bold text-emerald-700 dark:text-emerald-400">{s.bmi} ({s.bmiStatus})</span>
                      </div>
                    </div>
                  </div>
                );
            ...
            <div className="pt-6">
              {applySuccess && (
                <div className="mb-3 p-2.5 bg-emerald-100 dark:bg-emerald-950/80 border border-emerald-300 dark:border-emerald-700 rounded-xl text-xs font-bold text-emerald-800 dark:text-emerald-300 flex items-center space-x-1.5">
